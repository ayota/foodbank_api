...
from restapi.models import UPC, FoodCat, NutRule
...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		products  = PATH +'/restapi/fixtures/products.csv'
		...
		cats  = PATH +'/restapi/fixtures/categories.csv'
		...
		nuts  = PATH +'/restapi/fixtures/nutrules.csv'
